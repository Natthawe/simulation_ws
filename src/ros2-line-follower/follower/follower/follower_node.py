...
# Detect Black
lower_bgr_values = np.array([10, 10, 10])
upper_bgr_values = np.array([0, 0, 0])
...
def timer_callback():
    ...
    line, mark_side = get_contour_data(threshold, output[crop_h_start:crop_h_stop, crop_w_start:crop_w_stop])
